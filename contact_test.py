import unittest #Importing the the unittesting module
import pyperclip
...
class TestContact(unittest.TestCase):
    ...
    def test_save_contact(self):
        ...
        '''
        self.new_contact.save_contact() #Save new contact
        self.assertEqual(len(Contact.contact_list), 1)

    def test_save_multiple_contact(self):
        '''
        test_save_multiple_contacts tests to check whether we can save multiple contacts to our contact list.
        '''
    ...
    def test_find_contact_by_number(self):
        ...
        self.assertAlmostEqual(found_contact.email, test_contact.email)

    def test_contact_exists(self):
        '''
        test to check if we can return a boolean if contact doesn't exist
        '''
        self.new_contact.save_contact()
        test_contact = Contact("Test","user","0711223344","test@user.com") # new contact
        test_contact.save_contact()
